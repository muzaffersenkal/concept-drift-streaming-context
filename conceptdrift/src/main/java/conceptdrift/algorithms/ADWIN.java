...
public class ADWIN extends AbstractDetectorAlgorithm {

    public String name = "ADWIN";
    private class List  {
...
//			object.
    ...
    public void input(double intEntrada) {
         input(intEntrada, mdbldelta);
    }

    public boolean input(double intEntrada, double delta) {
